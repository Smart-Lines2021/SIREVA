    ...
    <div class="col-md-6">
        <div class="card card-info">
            ...
            <div class="card-body" style="display: block;">
                <form method="POST" action="{{route('empresas.update',Crypt::encryptString($empresa->id))}}">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="razon_social">Razón social:</label>
                        <input type="text" name="razon_social" value="{{old('razon_social',$empresa->razon_social)}}" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="domicilio" value="{{old('domicilio',$empresa->domicilio)}}" class="form-control"
                            placeholder="Ingrese el domicilio" minlegth="2" maxlength="100" title="">
                    </div>

                    <button class="btn btn-info btn-block">Editar empresa</button>
                </form>
            </div>
        </div>
    </div>
